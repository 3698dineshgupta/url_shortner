...
// ============================
app.get('*', (req, res) => {
  if (typeof frontendPath !== 'undefined' && fs.existsSync(path.join(frontendPath, 'index.html'))) {
    res.sendFile(path.resolve(frontendPath, 'index.html'));
  } else {
    res.status(404).send('Frontend not built locally, or unable to locate dist/index.html.');
  }
});
